...
<div align="center">
  ...
  <h5>나만의 AI 팀과 함께 만들기</h5>

  <p>
    openteams는 멀티 에이전트 협업을 위한 오픈 소스 워크스페이스입니다. AI 팀을 만들고, 로컬 코딩 에이전트를 실행하며, 채팅이나 구조화된 워크플로우를 통해 한곳에서 작업을 조율할 수 있습니다.
  </p>
...
- 이미 여러 코딩 에이전트를 사용 중인 개발자
- 수동 조율을 늘리지 않고 더 큰 레버리지를 원하는 독립 빌더
- AI-first 워크플로우를 도입하는 소규모 엔지니어링 팀
- 검토 가능하고 반복 가능한 에이전트 실행이 필요한 기술 리드
- 가벼운 채팅과 구조화된 워크플로우 오케스트레이션을 모두 원하는 팀
