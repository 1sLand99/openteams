...
assert.ok(tooltip.includes('app-tooltip command-tooltip pointer-events-none fixed'));
assert.ok(tooltip.includes('px-2.5 py-1.5 text-[11px] leading-4'));
assert.ok(tooltip.includes('whitespace-nowrap'));
assert.ok(tooltip.includes("side?: 'top' | 'bottom'"));
assert.ok(tooltip.includes("align?: 'center' | 'start' | 'end'"));
