...
const requiredKeys = [
  ...
  "permissions.fullAccessAgentConfirmDescription",
  "permissions.fullAccessAgentConfirmTitle",
  "permissions.fullAccessDescription",
  "permissions.fullAccessHighRisk",
  "permissions.fullAccessMemberConfirmDescription",
  "permissions.fullAccessMemberConfirmTitle",
